    ...
    public:
        ...
        void load(std::string _filename)
        {
            ...
            if (filename.at(0) == '/')
                ...
                im = cv::imread("/Users/soso/cpp-ARPRO/past-maze/mazes/" + filename, cv::IMREAD_GRAYSCALE);
        ...
        void save()
        {
            cv::imwrite("/Users/soso/cpp-ARPRO/past-maze/mazes/maze.png", im);
            display("Maze", im);
        }
        ...
        void saveSolution(std::string suffix)
        {
            ...
            cv::imwrite("/Users/soso/cpp-ARPRO/past-maze/mazes/" + name, out);
